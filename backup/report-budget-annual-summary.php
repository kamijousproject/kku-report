...
function fetchBudgetData($conn, $faculty = null)
{
    try {
        $query = "SELECT 
                    ...
                    pj.project_id,
                    pj.project_name,
                    LEFT(bap.[Account], 2) + REPLICATE('0', 8) AS a1,
                    ac.[type],
                    ...
                    SUM(CASE WHEN bap.Fund IN ('FN06', 'FN08', 'FN02') AND bap.Budget_Management_Year = 2568 THEN bap.Total_Amount_Quantity ELSE 0 END) AS Total_Amount_All_1,
                    ...
                    SUM(CASE WHEN bap.Fund IN ('FN06', 'FN08', 'FN02') AND bap.Budget_Management_Year = 2567 THEN bap.Total_Amount_Quantity ELSE 0 END) AS Total_Amount_All_2,
                    ...
                    SUM(CASE WHEN baap.Fund IN ('FN06', 'FN08', 'FN02') THEN baap.Allocated_Total_Amount_Quantity ELSE 0 END) AS Total_Allocated1,

                    -- Difference
                    SUM(CASE WHEN baap.Fund IN ('FN06', 'FN08', 'FN02') THEN baap.Allocated_Total_Amount_Quantity ELSE 0 END)
                    - 
                    SUM(CASE WHEN bap.Fund IN ('FN06', 'FN08', 'FN02') AND bap.Budget_Management_Year = 2567 THEN bap.Total_Amount_Quantity ELSE 0 END) 
                    AS Difference_Total_1,

                    -- Percentage
                    CASE 
                        WHEN SUM(CASE WHEN bap.Fund IN ('FN06', 'FN08', 'FN02') AND bap.Budget_Management_Year = 2567 THEN bap.Total_Amount_Quantity ELSE 0 END) = 0 
                            THEN 100
                        ELSE (
                            SUM(CASE WHEN baap.Fund IN ('FN06', 'FN08', 'FN02') THEN baap.Allocated_Total_Amount_Quantity ELSE 0 END)
                            - 
                ...
                LEFT JOIN account ac 
                    ON ac.account COLLATE Thai_CI_AS = bap.[Account] COLLATE Thai_CI_AS
                LEFT JOIN [plan] p 
