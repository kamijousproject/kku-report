...
<body class="v-light vertical-nav fix-header fix-sidebar">
    ...
    <script>
        ...
        function exportPDF() {
            ...
            doc.autoTable({
                ...
                didDrawPage: function(data) {
                    // Add header
                    doc.setFontSize(16);
                    doc.text('รายงานภาพรวมยุทธศาสตร์ ส่วนงาน/หน่วยงาน', 14, 15);
            ...
            // Save the PDF
            doc.save('รายงานภาพรวมยุทธศาสตร์ ส่วนงาน/หน่วยงาน.pdf');
        }
        ...
        function exportCSV() {
            ...
            csvMatrix[0][0] = `"รายงานภาพรวมยุทธศาสตร์ ส่วนงาน/หน่วยงาน"`;
            ...
            link.href = url;
            link.download = 'รายงานภาพรวมยุทธศาสตร์ ส่วนงาน/หน่วยงาน.csv';
        ...
        function exportXLS() {
            ...
            const row0 = ['รายงานภาพรวมยุทธศาสตร์ ส่วนงาน/หน่วยงาน']; // เพิ่มข้อความพิเศษที่แถวแรก
            ...
            const link = document.createElement('a');
            link.href = url;
            link.download = 'รายงานภาพรวมยุทธศาสตร์ ส่วนงาน/หน่วยงาน.xls';
            document.body.appendChild(link);
            link.click();
            document.body.removeChild(link);
            URL.revokeObjectURL(url);
