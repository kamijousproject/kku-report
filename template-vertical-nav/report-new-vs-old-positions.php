        ...
        $('#submitBtn').click(function() {
            ...
            data2.forEach((row, index) => {
                ...
                const columns = [{
                    ...
                    {
                        key: 'RETIREMENT_DATE',
                        value: row.RETIREMENT_DATE
                    },
                    {
                        key: 'Performance_Evaluation',
                        value: row.Performance_Evaluation
                    },
                    {
                        key: 'Performance_Evaluation_Percentage',
                        value: row.Performance_Evaluation_Percentage
                    },
                    {
                        key: 'Wish_to_Continue_Employement',
                        value: row.Wish_to_Continue_Employement
                    },
                    {
        ...
        function exportPDF() {
            ...
            doc.autoTable({
                ...
                columnStyles: {
                    ...
                    }, // ที่ - ตัวเลขให้อยู่กลาง
                    1: {
                        halign: 'left',
                        cellWidth: columnWidths[1]
                    }, // ส่วนงาน/หน่วยงาน - ชิดซ้าย
                    2: {
                        halign: 'left',
                    ...
                    }, // งบประมาณแผ่นดิน - ตัวเลขให้ชิดขวา
                    19: {
                        halign: 'right',
                        cellWidth: columnWidths[19]
                    }, // งบประมาณเงินรายได้ - ตัวเลขให้ชิดขวา
                    20: {
                        halign: 'right',
                        cellWidth: columnWidths[20]
                    }, // งบประมาณเงินรายได้ สนอ. - ตัวเลขให้ชิดขวา
                    21: {
                        halign: 'left',
                        cellWidth: columnWidths[21]
                    }, // สาขาวิชา/สถานที่ปฏิบัติงาน
                    22: {
                        halign: 'center',
                        cellWidth: columnWidths[22]
                    }, // สถานะการปฏิบัติงาน
                    23: {
                        halign: 'center',
                        cellWidth: columnWidths[23]
                    }, // วันที่เกษียณ
                    24: {
                        halign: 'center',
                        cellWidth: columnWidths[24]
                    }, // ผลประเมิน
                    25: {
                        halign: 'center',
                        cellWidth: columnWidths[25]
                    }, // ร้อยละ
                    26: {
                        halign: 'center',
                        cellWidth: columnWidths[26]
                    }, // ใช่/ไม่ใช่
                    27: {
                        halign: 'center',
                        cellWidth: columnWidths[27]
                    }, // ระยะเวลาการจ้าง
                },
