...
try:
    ...
    truncate_query = "TRUNCATE TABLE planning_kku_action_plan;"
    ...
    for _, row in data.iterrows():
        insert_query = '''
        INSERT INTO planning_kku_action_plan (
    ...
    # บันทึกข้อมูล
    connection.commit()
    # print("Data inserted successfully into planning_kku_action_plan table.")
    print("SUCCESS")
except Exception as e:
    print(f"Error: {e}")
